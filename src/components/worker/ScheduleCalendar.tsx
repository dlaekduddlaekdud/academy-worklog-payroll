import { getDaysInMonth } from "@/lib/utils/date-range";
...
export function ScheduleCalendar({ year, month, entries, title }: ScheduleCalendarProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-7 gap-px bg-border rounded-lg overflow-hidden">
        {grid.map((day, idx) => {
          if (day === null) {
            return <div key={`empty-${idx}`} className="bg-muted/30 min-h-[64px]" />;
          }
